...
# source://tty-cursor-0.7.1/lib/tty/cursor/version.rb:3
module TTY; end

# Terminal cursor movement ANSI codes
#
# source://tty-cursor-0.7.1/lib/tty/cursor/version.rb:4
module TTY::Cursor
  private
  ...
  # @param n [Integer]
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:94
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:137
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:143
  def clear_line; end
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:157
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:150
  ...
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:169
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:191
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:179
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:185
  ...
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:111
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:51
  def current; end

  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:94
  def cursor_backward(n = T.unsafe(nil)); end

  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:86
  def cursor_down(n = T.unsafe(nil)); end

  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:102
  def cursor_forward(n = T.unsafe(nil)); end

  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:78
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:24
  def hide; end
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:30
  ...
  # @param y [Integer]
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:70
  def move(x, y); end
  ...
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:59
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:125
  def next_line; end
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:131
  def prev_line; end
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:45
  def restore; end
  ...
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:119
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:39
  def save; end
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:203
  def scroll_down; end
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:197
  def scroll_up; end
  ...
  # @api public
  #
  # source://tty-cursor-0.7.1/lib/tty/cursor.rb:18
  def show; end
...
# source://tty-cursor-0.7.1/lib/tty/cursor.rb:11
TTY::Cursor::CSI = T.let(T.unsafe(nil), String)

# source://tty-cursor-0.7.1/lib/tty/cursor.rb:12
TTY::Cursor::DEC_RST = T.let(T.unsafe(nil), String)

# source://tty-cursor-0.7.1/lib/tty/cursor.rb:13
TTY::Cursor::DEC_SET = T.let(T.unsafe(nil), String)

# source://tty-cursor-0.7.1/lib/tty/cursor.rb:14
TTY::Cursor::DEC_TCEM = T.let(T.unsafe(nil), String)

# source://tty-cursor-0.7.1/lib/tty/cursor.rb:10
TTY::Cursor::ESC = T.let(T.unsafe(nil), String)

# source://tty-cursor-0.7.1/lib/tty/cursor/version.rb:5
