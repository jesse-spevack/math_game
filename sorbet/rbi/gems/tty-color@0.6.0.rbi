...
# source://tty-color-0.6.0/lib/tty/color/mode.rb:3
module TTY; end
...
# @api public
#
# source://tty-color-0.6.0/lib/tty/color/mode.rb:4
module TTY::Color
  extend ::TTY::Color
  ...
  # @return [Boolean]
  #
  # source://tty-color-0.6.0/lib/tty/color.rb:27
  def color?; end
  ...
  # @return [Boolean]
  #
  # source://tty-color-0.6.0/lib/tty/color.rb:67
  def command?(cmd); end
  ...
  #
  # source://tty-color-0.6.0/lib/tty/color.rb:40
  def disabled?; end
  ...
  # @return [Integer]
  #
  # source://tty-color-0.6.0/lib/tty/color.rb:49
  def mode; end

  # @api public
  #
  # source://tty-color-0.6.0/lib/tty/color.rb:20
  def output; end
  ...
  # @return [Boolean]
  #
  # source://tty-color-0.6.0/lib/tty/color.rb:58
  def tty?; end
  ...
  # @return [Boolean]
  #
  # source://tty-color-0.6.0/lib/tty/color.rb:76
  def windows?; end
end

# source://tty-color-0.6.0/lib/tty/color/mode.rb:5
class TTY::Color::Mode
  # @return [Mode] a new instance of Mode
  #
  # source://tty-color-0.6.0/lib/tty/color/mode.rb:31
  ...
  #
  # source://tty-color-0.6.0/lib/tty/color/mode.rb:57
  def from_term; end
  ...
  # @return [NoValue, Integer]
  #
  # source://tty-color-0.6.0/lib/tty/color/mode.rb:77
  def from_tput; end
  ...
  #
  # source://tty-color-0.6.0/lib/tty/color/mode.rb:41
  def mode; end
end

# source://tty-color-0.6.0/lib/tty/color/mode.rb:29
TTY::Color::Mode::METHODS = T.let(T.unsafe(nil), Array)

# source://tty-color-0.6.0/lib/tty/color/mode.rb:18
TTY::Color::Mode::TERM_16 = T.let(T.unsafe(nil), Regexp)

# source://tty-color-0.6.0/lib/tty/color/mode.rb:6
TTY::Color::Mode::TERM_24BIT = T.let(T.unsafe(nil), Regexp)

# source://tty-color-0.6.0/lib/tty/color/mode.rb:9
TTY::Color::Mode::TERM_256 = T.let(T.unsafe(nil), Regexp)

# source://tty-color-0.6.0/lib/tty/color/mode.rb:16
TTY::Color::Mode::TERM_52 = T.let(T.unsafe(nil), Regexp)

# source://tty-color-0.6.0/lib/tty/color/mode.rb:13
TTY::Color::Mode::TERM_64 = T.let(T.unsafe(nil), Regexp)

# source://tty-color-0.6.0/lib/tty/color/mode.rb:27
TTY::Color::Mode::TERM_8 = T.let(T.unsafe(nil), Regexp)

# 8 bits per RGB channel
#
# source://tty-color-0.6.0/lib/tty/color/mode.rb:7
TTY::Color::Mode::TRUECOLORS = T.let(T.unsafe(nil), Integer)

# @api public
#
# source://tty-color-0.6.0/lib/tty/color.rb:14
module TTY::Color::NoValue; end

# source://tty-color-0.6.0/lib/tty/color/support.rb:5
class TTY::Color::Support
  ...
  #
  # source://tty-color-0.6.0/lib/tty/color/support.rb:30
  ...
  # @return [Boolean] true when terminal color support has been disabled, false otherwise
  #
  # source://tty-color-0.6.0/lib/tty/color/support.rb:58
  def disabled?; end
  ...
  # @return [Boolean]
  #
  # source://tty-color-0.6.0/lib/tty/color/support.rb:97
  ...
  # @api private
  #
  # source://tty-color-0.6.0/lib/tty/color/support.rb:88
  def from_env; end
  ...
  # @api private
  #
  # source://tty-color-0.6.0/lib/tty/color/support.rb:66
  def from_term; end
  ...
  # @api private
  #
  # source://tty-color-0.6.0/lib/tty/color/support.rb:77
  def from_tput; end
  ...
  #
  # source://tty-color-0.6.0/lib/tty/color/support.rb:41
  def support?; end
end

# source://tty-color-0.6.0/lib/tty/color/support.rb:7
TTY::Color::Support::ENV_VARS = T.let(T.unsafe(nil), Array)

# source://tty-color-0.6.0/lib/tty/color/support.rb:6
TTY::Color::Support::SOURCES = T.let(T.unsafe(nil), Array)

# source://tty-color-0.6.0/lib/tty/color/support.rb:9
TTY::Color::Support::TERM_REGEX = T.let(T.unsafe(nil), Regexp)

# source://tty-color-0.6.0/lib/tty/color/version.rb:5
