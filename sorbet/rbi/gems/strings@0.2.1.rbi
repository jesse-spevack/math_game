...
# source://strings-0.2.1/lib/strings/align.rb:6
module Strings
  private
...
#
# source://strings-0.2.1/lib/strings/align.rb:8
module Strings::Align
  ...
  #
  # source://strings-0.2.1/lib/strings/align.rb:39
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/align.rb:86
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/align.rb:66
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/align.rb:108
  ...
  # @api private
  #
  # source://strings-0.2.1/lib/strings/align.rb:142
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/align.rb:130
  ...
  # @api private
  #
  # source://strings-0.2.1/lib/strings/align.rb:50
...
# source://strings-0.2.1/lib/strings/align.rb:11
Strings::Align::LINE_BREAK = T.let(T.unsafe(nil), Regexp)

# source://strings-0.2.1/lib/strings/align.rb:9
Strings::Align::NEWLINE = T.let(T.unsafe(nil), String)

# source://strings-0.2.1/lib/strings/align.rb:10
Strings::Align::SPACE = T.let(T.unsafe(nil), String)

# source://strings-0.2.1/lib/strings/fold.rb:4
module Strings::Fold
  private
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/fold.rb:20
...
# source://strings-0.2.1/lib/strings/fold.rb:5
Strings::Fold::LINE_BREAK = T.let(T.unsafe(nil), String)

# Responsible for text padding
#
# source://strings-0.2.1/lib/strings/pad.rb:10
module Strings::Pad
  private
  ...
  # @return [Integer]
  #
  # source://strings-0.2.1/lib/strings/pad.rb:91
  def display_width(string); end
  ...
  # @return [Integer]
  #
  # source://strings-0.2.1/lib/strings/pad.rb:80
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/pad.rb:34
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/pad.rb:67
...
# source://strings-0.2.1/lib/strings/pad.rb:13
Strings::Pad::LINE_BREAK = T.let(T.unsafe(nil), Regexp)

# source://strings-0.2.1/lib/strings/pad.rb:11
Strings::Pad::NEWLINE = T.let(T.unsafe(nil), String)

# source://strings-0.2.1/lib/strings/pad.rb:12
...
# @api private
#
# source://strings-0.2.1/lib/strings/padder.rb:9
class Strings::Padder
  ...
  #
  # source://strings-0.2.1/lib/strings/padder.rb:60
  ...
  # @return [Integer]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:107
  def bottom; end
  ...
  # @return [nil]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:118
  ...
  # @return [Boolean]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:147
  def empty?; end
  ...
  # @return [Integer]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:127
  def left; end
  ...
  # @return [nil]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:138
  def left=(value); end
  ...
  #
  # source://strings-0.2.1/lib/strings/padder.rb:55
  def padding; end
  ...
  # @return [Integer]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:89
  def right; end
  ...
  # @param value [Integer]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:98
  def right=(value); end
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:156
  def to_s; end
  ...
  # @return [Integer]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:69
  def top; end
  ...
  # @return [nil]
  #
  # source://strings-0.2.1/lib/strings/padder.rb:80
  def top=(value); end
  ...
  class << self
    ...
    #
    # source://strings-0.2.1/lib/strings/padder.rb:38
    ...
    #
    # source://strings-0.2.1/lib/strings/padder.rb:26
...
# @api private
#
# source://strings-0.2.1/lib/strings/padder.rb:10
class Strings::Padder::ParseError < ::ArgumentError; end

# A module responsible for text truncation
#
# source://strings-0.2.1/lib/strings/truncate.rb:9
module Strings::Truncate
  ...
  # @api private
  #
  # source://strings-0.2.1/lib/strings/truncate.rb:102
  def display_width(string); end
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/truncate.rb:71
  def shorten(original_chars, chars, length_without_trailing); end

  # @api private
  #
  # source://strings-0.2.1/lib/strings/truncate.rb:94
  ...
  #
  # source://strings-0.2.1/lib/strings/truncate.rb:42
...
# source://strings-0.2.1/lib/strings/truncate.rb:12
Strings::Truncate::DEFAULT_LENGTH = T.let(T.unsafe(nil), Integer)

# source://strings-0.2.1/lib/strings/truncate.rb:10
...
# source://strings-0.2.1/lib/strings/wrap.rb:8
module Strings::Wrap
  private
  ...
  # @api private
  #
  # source://strings-0.2.1/lib/strings/wrap.rb:170
  def display_width(string); end
  ...
  #
  # source://strings-0.2.1/lib/strings/wrap.rb:46
  ...
  # @return [String]
  #
  # source://strings-0.2.1/lib/strings/wrap.rb:131
  ...
  #   # => "Some \nlongish \ntext"
  #
  # source://strings-0.2.1/lib/strings/wrap.rb:23
...
# source://strings-0.2.1/lib/strings/wrap.rb:9
Strings::Wrap::DEFAULT_WIDTH = T.let(T.unsafe(nil), Integer)

# source://strings-0.2.1/lib/strings/wrap.rb:12
Strings::Wrap::LINE_BREAK = T.let(T.unsafe(nil), Regexp)

# source://strings-0.2.1/lib/strings/wrap.rb:13
Strings::Wrap::LINE_BREAKS = T.let(T.unsafe(nil), String)

# source://strings-0.2.1/lib/strings/wrap.rb:10
Strings::Wrap::NEWLINE = T.let(T.unsafe(nil), String)

# source://strings-0.2.1/lib/strings/wrap.rb:11
