...
# source://pastel-0.8.0/lib/pastel/alias_importer.rb:3
module Pastel
  private
  ...
  # @return [Delegator]
  #
  # source://pastel-0.8.0/lib/pastel.rb:31
...
#
# source://pastel-0.8.0/lib/pastel/ansi.rb:5
module Pastel::ANSI
  private

  # source://pastel-0.8.0/lib/pastel/ansi.rb:62
  def background?(code); end

  # source://pastel-0.8.0/lib/pastel/ansi.rb:58
  def foreground?(code); end

  # source://pastel-0.8.0/lib/pastel/ansi.rb:66
  def style?(code); end
...
class Pastel::AliasImporter
  ...
  #
  # source://pastel-0.8.0/lib/pastel/alias_importer.rb:12
  ...
  # @return [nil]
  #
  # source://pastel-0.8.0/lib/pastel/alias_importer.rb:27
  def import; end
  ...
  #
  # source://pastel-0.8.0/lib/pastel/alias_importer.rb:44
  def color; end
...
#
# source://pastel-0.8.0/lib/pastel/color.rb:7
class Pastel::Color
  include ::Pastel::ANSI
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:24
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:235
  def ==(other); end
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:206
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:78
  ...
  # @api public
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:85
  def clear; end
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:148
  def code(*colors); end
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:117
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:54
  ...
  # @api public
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:33
  def disable!; end

  # Returns the value of attribute eachline.
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:19
  def eachline; end

  # Returns the value of attribute enabled.
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:16
  def enabled; end
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:225
  def eql?(other); end
  ...
  # @return [Numeric]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:254
  def hash; end
  ...
  # @return [String]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:245
  def inspect; end
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:136
  ...
  # @return [String]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:103
  ...
  # @return [Array[Symbol]]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:175
  def style_names; end
  ...
  # @return [Hash[Symbol]]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:166
  def styles; end
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:191
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:265
  def blank?(value); end

  # @api private
  # @raise [InvalidAttributeNameError]
  #
  # source://pastel-0.8.0/lib/pastel/color.rb:270
  def validate(*colors); end
end

# All color aliases
#
# source://pastel-0.8.0/lib/pastel/color.rb:11
Pastel::Color::ALIASES = T.let(T.unsafe(nil), Hash)

# Match all color escape sequences
#
# source://pastel-0.8.0/lib/pastel/color.rb:14
...
# @api private
#
# source://pastel-0.8.0/lib/pastel/color_parser.rb:13
class Pastel::ColorParser
  ...
  class << self
    ...
    # @return [Symbol]
    #
    # source://pastel-0.8.0/lib/pastel/color_parser.rb:104
    ...
    # @return [String]
    #
    # source://pastel-0.8.0/lib/pastel/color_parser.rb:119
    ...
    #
    # source://pastel-0.8.0/lib/pastel/color_parser.rb:33
    def parse(text); end
    ...
    #
    # source://pastel-0.8.0/lib/pastel/color_parser.rb:90
...
# @api private
#
# source://pastel-0.8.0/lib/pastel/color_parser.rb:17
Pastel::ColorParser::CSI = T.let(T.unsafe(nil), String)

# @api private
#
# source://pastel-0.8.0/lib/pastel/color_parser.rb:16
...
# @api private
#
# source://pastel-0.8.0/lib/pastel/color_resolver.rb:11
class Pastel::ColorResolver
  ...
  #
  # source://pastel-0.8.0/lib/pastel/color_resolver.rb:21
  ...
  # @api public
  #
  # source://pastel-0.8.0/lib/pastel/color_resolver.rb:14
  def color; end
  ...
  # @api private
  #
  # source://pastel-0.8.0/lib/pastel/color_resolver.rb:28
...
# @api private
#
# source://pastel-0.8.0/lib/pastel/decorator_chain.rb:7
class Pastel::DecoratorChain
  ...
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:22
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:60
  def ==(other); end
  ...
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:31
  ...
  # @api public
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:42
  def each(&block); end
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:51
  def eql?(other); end
  ...
  # @return [Numeric]
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:78
  def hash; end
  ...
  # @return [String]
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:69
  def inspect; end
  ...
  # @api private
  #
  # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:84
  def decorators; end
  ...
  class << self
    ...
    #
    # source://pastel-0.8.0/lib/pastel/decorator_chain.rb:15
    def empty; end
  end
end
...
# @api private
#
# source://pastel-0.8.0/lib/pastel/delegator.rb:13
class Pastel::Delegator
  ...
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:38
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:57
  def ==(other); end
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:48
  def eql?(other); end
  ...
  # @return [Numeric]
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:76
  def hash; end
  ...
  # @return [String]
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:66
  def inspect; end
  ...
  # @api private
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:82
  def chain; end
  ...
  # @api private
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:112
  ...
  # @api private
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:89
  def method_missing(method_name, *args, &block); end

  # @api private
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:84
  def resolver; end
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/delegator.rb:104
  ...
  class << self
    ...
    # @api public
    #
    # source://pastel-0.8.0/lib/pastel/delegator.rb:25
...
#
# source://pastel-0.8.0/lib/pastel/detached.rb:5
class Pastel::Detached
  ...
  #
  # source://pastel-0.8.0/lib/pastel/detached.rb:14
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/detached.rb:57
  def ==(other); end
  ...
  # @return [String]
  #
  # source://pastel-0.8.0/lib/pastel/detached.rb:32
  def [](*args); end
  ...
  # @return [Boolean]
  #
  # source://pastel-0.8.0/lib/pastel/detached.rb:48
  def eql?(other); end
  ...
  # @return [Numeric]
  #
  # source://pastel-0.8.0/lib/pastel/detached.rb:75
  def hash; end
  ...
  # @return [String]
  #
  # source://pastel-0.8.0/lib/pastel/detached.rb:66
  def inspect; end

  # @api public
  #
  # source://pastel-0.8.0/lib/pastel/detached.rb:39
  def to_proc; end
